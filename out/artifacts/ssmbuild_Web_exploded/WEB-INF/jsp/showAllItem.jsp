                ...
                <div class="col-md-8">
                    <div style="overflow:scroll;height:70vh;">
                        <table class="table table-borderless table-hover">
                            ...
                            <c:forEach var="vinItem" items="${vinItem}">
                                <c:set var="headCount" value="${headCount + 1}"/>
                                <tr>
                                    <th class="table-customize" scope="row">${headCount}. ${vinItem.itemName}</th>
                                    <td class="table-customize2" hidden>${vinItem.id}</td>
                                    <td class="table-customize2"><a class="btn btn-primary" href="${pageContext.request.contextPath}/change/toChangeItemName?id=${vinItem.id}">修改</a></td>
