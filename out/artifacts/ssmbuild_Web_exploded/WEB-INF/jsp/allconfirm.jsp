...
<%--                        <th hidden>编号</th>--%>
                    ...
                    <c:forEach var="listItem" items="${listItem}">
                        ...
                        <tr>
                            ...
                            <td class="table-customize2">${listItem.action}</td>
                            <td class="table-customize2">${listItem.from}</td>
                            <td class="table-customize2">${listItem.to}</td>
                            <c:if test="${listItem.ifComplete.equals(true)}">
                                <td class="table-customize2">${listItem.ifConfirm}</td>
                            </c:if>
                            <c:if test="${listItem.ifComplete.equals(false)}">
                                <td class="table-customize2">${listItem.ifConfirm}</td>
                            </c:if>
                            <td class="table-customize2"><a href="${pageContext.request.contextPath}/upload/${listItem.logid}.png" target="_blank">截圖</a></td>
                            <c:if test="${function.equals('notpass')}">
                                <td class="table-customize2">
                                    <button class="btn btn-primary">通過</button>
                                </td>
                            </c:if>
                                <td class="table-customize2">
...
<%--                        <th hidden>编号</th>--%>
                    ...
                    <c:forEach var="listFood" items="${listFood}">
                        ...
                        <tr>
                            ...
                            <td class="table-customize2">${listFood.action}</td>
                            <td class="table-customize2">${listFood.from}</td>
                            <td class="table-customize2">${listFood.to}</td>
                            <c:if test="${listFood.ifComplete.equals(true)}">
                                <td class="table-customize2">${listFood.ifConfirm}</td>
                            </c:if>
                            <c:if test="${listFood.ifComplete.equals(false)}">
                                <td class="table-customize2">${listFood.ifConfirm}</td>
                            </c:if>
                            <td class="table-customize2"><a href="${pageContext.request.contextPath}/upload/${listFood.logid}.png" target="_blank">截圖</a></td>
                            <c:if test="${function.equals('notpass')}">
                                <td class="table-customize2">
                                    <button class="btn btn-primary">通過</button>
                                </td>
...
<%--                        <th hidden>编号</th>--%>
                    ...
                    <c:forEach var="listSmallItem" items="${listSmallItem}">
                        ...
                        <tr>
                            ...
                            <td class="table-customize2">${listSmallItem.action}</td>
                            <td class="table-customize2">${listSmallItem.from}</td>
                            <td class="table-customize2">${listSmallItem.to}</td>
                            <c:if test="${listSmallItem.ifComplete.equals(true)}">
                                <td class="table-customize2">${listSmallItem.ifConfirm}</td>
                            </c:if>
                            <c:if test="${listSmallItem.ifComplete.equals(false)}">
                                <td class="table-customize2">${listSmallItem.ifConfirm}</td>
                            </c:if>
                            <td class="table-customize2"><a href="${pageContext.request.contextPath}/upload/${listSmallItem.logid}.png" target="_blank">截圖</a></td>
                            <c:if test="${function.equals('notpass')}">
                                <td class="table-customize2">
                                    <button class="btn btn-primary">通過</button>
                                </td>
...
<%--                        <th hidden>编号</th>--%>
                    ...
                    <c:forEach var="listCommercialthing" items="${listCommercialthing}">
                        ...
                        <tr>
                            ...
                            <td class="table-customize2">${listCommercialthing.action}</td>
                            <td class="table-customize2">${listCommercialthing.from}</td>
                            <td class="table-customize2">${listCommercialthing.to}</td>
                            <c:if test="${listCommercialthing.ifComplete.equals(true)}">
                                <td class="table-customize2">${listCommercialthing.ifConfirm}</td>
                            </c:if>
                            <c:if test="${listCommercialthing.ifComplete.equals(false)}">
                                <td class="table-customize2">${listCommercialthing.ifConfirm}</td>
                            </c:if>
                            <td class="table-customize2"><a href="${pageContext.request.contextPath}/upload/${listCommercialthing.logid}.png" target="_blank">截圖</a></td>
                            <c:if test="${function.equals('notpass')}">
                                <td class="table-customize2">
                                    <button class="btn btn-primary">通過</button>
                                </td>
...
<%--                        <th hidden>编号</th>--%>
                    ...
                    <c:forEach var="listOther" items="${listOther}">
                        ...
                        <tr>
                            ...
                            <td class="table-customize2">${listOther.action}</td>
                            <td class="table-customize2">${listOther.from}</td>
                            <td class="table-customize2">${listOther.to}</td>
                            <c:if test="${listOther.ifComplete.equals(true)}">
                                <td class="table-customize2">${listOther.ifConfirm}</td>
                            </c:if>
                            <c:if test="${listOther.ifComplete.equals(false)}">
                                <td class="table-customize2">${listOther.ifConfirm}</td>
                            </c:if>
                            <td class="table-customize2"><a href="${pageContext.request.contextPath}/upload/${listOther.logid}.png" target="_blank">截圖</a></td>
                            <c:if test="${function.equals('notpass')}">
                                <td class="table-customize2">
                                    <button class="btn btn-primary">通過</button>
                                </td>
