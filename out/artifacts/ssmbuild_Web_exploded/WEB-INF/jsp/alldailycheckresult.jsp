                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <form action="${pageContext.request.contextPath}/${mainWarehouse}/downloadTool" method="post" class="row g-3" >
                                        <%--                        <div class="col-auto">--%>
                                        ...
                                        <div class="col-auto">
                                            <button type="submit" class="btn btn-primary mb-3">下載設備CSV</button>
                                        </div>
                                        <div class="col-auto">
                                            <button type="submit" formaction="${pageContext.request.contextPath}/${mainWarehouse}/downloadSmallTool" class="btn btn-primary mb-3">下載小器具CSV</button>
                                        </div>
                                        <div class="col-auto">
                                            <button type="submit" formaction="${pageContext.request.contextPath}/${mainWarehouse}/downloadFood" class="btn btn-primary mb-3">下載材料CSV</button>
                                        </div>
                                        <div class="col-auto">
                                            <button type="submit" formaction="${pageContext.request.contextPath}/${mainWarehouse}/downloadCommercial" class="btn btn-primary mb-3">下載宣傳物料CSV</button>
                                        </div>
                                        <div class="col-auto">
                                            <button type="submit" formaction="${pageContext.request.contextPath}/${mainWarehouse}/downloadOther" class="btn btn-primary mb-3">下載其他CSV</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
