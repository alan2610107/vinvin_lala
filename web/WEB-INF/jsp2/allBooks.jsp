                ...
                <c:forEach var="book" items="${list}">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp; |  &nbsp;
                            <a href="${pageContext.request.contextPath}/book/toInputBook?id=${book.bookID}">入庫</a>
                            &nbsp; |  &nbsp;
                            <a href="${pageContext.request.contextPath}/book/toSend?id=${book.bookID}">轉移</a>
                        </td>
