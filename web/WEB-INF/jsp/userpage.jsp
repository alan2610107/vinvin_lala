                        ...
                        <c:forEach var="userpage" items="${userpageList}"><c:if test="${userLevel == 1000 || userLevel == 1 && userpage.location.equals('shop1')
                                ...
                                || userLevel == 5 && userpage.location.equals('shop5')
                                 || userLevel == 6 && userpage.location.equals('shop6')
                                  || userLevel == 7 && userpage.location.equals('shop7')
                                   || userLevel == 8 && userpage.location.equals('shop8')
                                    || userLevel == 9 && userpage.location.equals('shop9')
                                     || userLevel == 10 && userpage.location.equals('shop10')}">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="${pageContext.request.contextPath}/receive/setExpiredDate?location=${userpage.location}" target="_blank">未輸入過期日 ${userpage.notInputDateinExpiredCount}</a></li>
