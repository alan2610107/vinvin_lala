                ...
                <table class="table table-borderless table-hover">
                    ...
                    <c:forEach var="fruitInvoice" items="${fruitInvoices}">
                        ...
                        <tr>
                            ...
                            <th class="table-customize" scope="row">${headCount}. ${fruitInvoice.supplier}</th>
                            <td class="table-customize2">${fruitInvoice.time}</td>
                            <td class="table-customize2">${fruitInvoice.invoiceTime}</td>
                            <td class="table-customize2">${fruitInvoice.price}</td>
                            <td class="table-customize2">${fruitInvoice.memo}</td>
                            <td class="table-customize2">
                                <a class="btn btn-success" href="${pageContext.request.contextPath}/invoice/showphoto?invoiceid=${id}" target="_blank" style="padding: 1px !important;">水果運單</a>
                            </td>
                            <td class="table-customize2">
                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/invoice/toedit?invoiceid=${id}" style="padding: 1px !important;">編輯</a>
                            </td>
                            <td class="table-customize2">
                                <a class="btn btn-danger" href="${pageContext.request.contextPath}/invoice/delete?invoiceid=${id}&location=${fruitInvoice.location}" style="padding: 1px !important;">刪除</a>
                            </td>
