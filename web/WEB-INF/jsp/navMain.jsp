...
<%--                &lt;%&ndash;                        </li>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                        <li><a class="dropdown-item"&ndash;%&gt;--%>
<%--                &lt;%&ndash;                               href="${pageContext.request.contextPath}/receive/error?location=shop6">莞南城保利</a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                        </li>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                        <li><a class="dropdown-item"&ndash;%&gt;--%>
...
<%--                &lt;%&ndash;                    </ul>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                </li>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                <c:if test="${userLevel == 1000}">&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    <li class="nav-item dropdown">&ndash;%&gt;--%>
<%--                &lt;%&ndash;                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            新增&ndash;%&gt;--%>
<%--                &lt;%&ndash;                        </a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            <li><a class="dropdown-item"&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                   href="${pageContext.request.contextPath}/${mainWarehouse}/toAdd?location=${mainWarehouseEN}&category=tool">新增設備</a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            </li>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            <li><a class="dropdown-item"&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                   href="${pageContext.request.contextPath}/${mainWarehouse}/toAdd?location=${mainWarehouseEN}&category=food">新增材料</a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            </li>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            <li><a class="dropdown-item"&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                   href="${pageContext.request.contextPath}/${mainWarehouse}/toAdd?location=${mainWarehouseEN}&category=smalltool">新增小器具</a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            </li>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            <li><a class="dropdown-item"&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                   href="${pageContext.request.contextPath}/${mainWarehouse}/toAdd?location=${mainWarehouseEN}&category=commercialthing">新增宣传物料</a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            </li>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            <li><a class="dropdown-item"&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                   href="${pageContext.request.contextPath}/${mainWarehouse}/toAdd?location=${mainWarehouseEN}&category=other">新增其他</a>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                            </li>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                        </ul>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                    </li>&ndash;%&gt;--%>
