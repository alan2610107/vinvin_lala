...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <a class="btn btn-success" role="button" href="${pageContext.request.contextPath}/receive/error?location=${logLocation}">待入庫例外</a>
        </div>
        <div class="col-md-12 column">
            <br>
            <tag style="color: red">*如果按下「送出」按鈕該物品還在，重整一下頁面看還在不在</tag>
        </div>
        <div class="col-md-12 column">
            <br><br><br>
            <div class="row">
                ...
                <table id="tooltable" class="table table-hover table-striped">
                    ...
                    <c:forEach var="listItem" items="${listItem}">
                        ...
                        <tr>
                            ...
                            <td>${listItem.memo}</td>
                            <td>${listItem.time}</td>
                            <td>${actionMap[listItem.action]}</td>
                            <td>${warehouseMap[listItem.from]}</td>
                            <td>${warehouseMap[listItem.to]}</td>
                            <c:if test="${listItem.ifComplete.equals(true)}">
                                <td>${statusMap[listItem.ifComplete]}</td>
                            </c:if>
                            <c:if test="${listItem.ifComplete.equals(false)}">
                                <td style="color: #ff0000;font-weight:bold">${statusMap[listItem.ifComplete]}</td>
                            </c:if>
                ...
                <table id="foodtable" class="table table-hover table-striped">
                    ...
                    <c:forEach var="listFood" items="${listFood}">
                        ...
                        <tr>
                            ...
                            <td>${listFood.memo}</td>
                            <td>${listFood.time}</td>
                            <td>${actionMap[listFood.action]}</td>
                            <td>${warehouseMap[listFood.from]}</td>
                            <td>${warehouseMap[listFood.to]}</td>
                            <c:if test="${listFood.ifComplete.equals(true)}">
                                <td>${statusMap[listFood.ifComplete]}</td>
                            </c:if>
                            <c:if test="${listFood.ifComplete.equals(false)}">
                                <td style="color: #ff0000;font-weight:bold">${statusMap[listFood.ifComplete]}</td>
                            </c:if>
                ...
                <table id="smalltooltable" class="table table-hover table-striped">
                    ...
                    <c:forEach var="listSmallItem" items="${listSmallItem}">
                        ...
                        <tr>
                            ...
                            <td>${actionMap[listSmallItem.action]}</td>
                            <td>${warehouseMap[listSmallItem.from]}</td>
                            <td>${warehouseMap[listSmallItem.to]}</td>
                            <c:if test="${listSmallItem.ifComplete.equals(true)}">
                                <td>${statusMap[listSmallItem.ifComplete]}</td>
                            </c:if>
                            <c:if test="${listSmallItem.ifComplete.equals(false)}">
                                <td style="color: #ff0000;font-weight:bold">${statusMap[listSmallItem.ifComplete]}</td>
                            </c:if>
                                <%--                        <td>--%>
                ...
                <table id="commercialtable" class="table table-hover table-striped">
                    ...
                    <c:forEach var="listCommercialItem" items="${listCommercialItem}">
                        ...
                        <tr>
                            ...
                            <td>${actionMap[listCommercialItem.action]}</td>
                            <td>${warehouseMap[listCommercialItem.from]}</td>
                            <td>${warehouseMap[listCommercialItem.to]}</td>
                            <c:if test="${listCommercialItem.ifComplete.equals(true)}">
                                <td>${statusMap[listCommercialItem.ifComplete]}</td>
                            </c:if>
                            <c:if test="${listCommercialItem.ifComplete.equals(false)}">
                                <td style="color: #ff0000;font-weight:bold">${statusMap[listCommercialItem.ifComplete]}</td>
                            </c:if>
                                <%--                        <td>--%>
                                <%--                            <a href="${pageContext.request.contextPath}/${mainWarehouse}/toUpdatesmalltool?id=${listSmallItem.id}">修改</a>--%>
                                <%--                            &nbsp; | &nbsp;--%>
                ...
                <table id="othertable" class="table table-hover table-striped">
                    ...
                    <c:forEach var="listOtherItem" items="${listOtherItem}">
                        ...
                        <tr>
                            ...
                            <td>${actionMap[listOtherItem.action]}</td>
                            <td>${warehouseMap[listOtherItem.from]}</td>
                            <td>${warehouseMap[listOtherItem.to]}</td>
                            <c:if test="${listOtherItem.ifComplete.equals(true)}">
                                <td>${statusMap[listOtherItem.ifComplete]}</td>
                            </c:if>
                            <c:if test="${listOtherItem.ifComplete.equals(false)}">
                                <td style="color: #ff0000;font-weight:bold">${statusMap[listOtherItem.ifComplete]}</td>
                            </c:if>
